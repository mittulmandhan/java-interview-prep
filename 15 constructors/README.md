...
* As we know by default constructors have the same access level as the class and class cannot be private. Hence, default constructor cannot be private as well.
